...
fun WidgetContent(stats: WidgetStats) {
    Column(
        ...
        Text("Device Stats", style = TextStyle(color = androidx.glance.unit.ColorProvider(Color.White), fontWeight = FontWeight.Bold, fontSize = 16.sp), modifier = GlanceModifier.padding(bottom = 8.dp))
        Row(modifier = GlanceModifier.fillMaxWidth().padding(bottom = 4.dp)) {
            Text("Battery:", style = TextStyle(color = androidx.glance.unit.ColorProvider(Color.Gray), fontSize = 14.sp), modifier = GlanceModifier.width(64.dp))
        ...
        Row(modifier = GlanceModifier.fillMaxWidth().padding(bottom = 4.dp)) {
            Text("RAM:", style = TextStyle(color = androidx.glance.unit.ColorProvider(Color.Gray), fontSize = 14.sp), modifier = GlanceModifier.width(64.dp))
        ...
        Row(modifier = GlanceModifier.fillMaxWidth()) {
            Text("Storage:", style = TextStyle(color = androidx.glance.unit.ColorProvider(Color.Gray), fontSize = 14.sp), modifier = GlanceModifier.width(64.dp))
